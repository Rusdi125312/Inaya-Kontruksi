...
export default function Portfolio() {
  ...
  return (
    <main className="bg-black text-white min-h-screen">
      ...
      {/* SECTION VIDEO UTAMA DI BAGIAN ATAS */}
      <section className="py-12 bg-black text-white border-b border-white/10">
        <div className="max-w-5xl mx-auto px-4 md:px-6">
          ...
          >
            <h3 className="text-[#D4AF37] tracking-[0.3em] uppercase text-[10px] font-bold mb-2">Featured Video</h3>
            <h2 className="text-2xl md:text-3xl font-serif font-bold">Proses & Hasil Kerja Kami</h2>
          </motion.div>

          <motion.div 
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="w-full aspect-video relative overflow-hidden rounded-2xl border border-white/10 bg-[#111] shadow-2xl"
          >
            {/* Ganti tag <video> di bawah ini sesuai sumber video Anda */}
            <video 
              controls 
              autoPlay 
              muted 
            ...
            >
              {/* Masukkan link video Anda di src (bisa file lokal di public atau link external) */}
